            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <textarea class="form-control" rows="5" name="description" id="input_description" placeholder="description of de category"></textarea>
                </div>  
              </div>
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <form id="formUpdateCategory" method="POST" action="{{ url('categories') }}">
            @csrf
            @method('PUT')
            ...
            <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <div class="input-group mb-3">
                  ...
                  <textarea class="form-control" rows="5" name="description" id="description" placeholder="description of de category"></textarea>
                </div>  
              </div>
